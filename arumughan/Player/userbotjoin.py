...
from arumughan.decorators import authorized_users_only, sudo_users_only, errors
from arumughan.filters import command, other_filters
from arumughan.main import Test as USER
from pyrogram import filters
from arumughan.main import bot as Client, bot as app
from pyrogram.errors import UserAlreadyParticipant
from arumughan.Client.assistant import get_assistant_details, random_assistant
from arumughan.Database.active import get_active_chats


@Client.on_message(filters.command(["join", "uj"]) & filters.user(SUDO_USERS))
...
@app.on_message(filters.command("la") & filters.user(SUDO_USERS))
