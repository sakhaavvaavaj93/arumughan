from arumughan.Cache.admins import admins
from arumughan.main import call_py, call_py2, call_py3, call_py4, call_py5
...
from arumughan.Database.active import remove_active_video_chat, remove_active_chat
...
async def cbval(_, query: CallbackQuery):
     from arumughan.inline import menu_markup
